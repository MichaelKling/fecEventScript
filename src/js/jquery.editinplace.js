...
$.extend(InlineEditor.prototype, {
	...
	replaceContentWithEditor: function() {
		...
		var formElement = $('<form class="inplace_form" style="display: inline; margin: 0; padding: 0;"></form>');
		this.dom.html(formElement)
		formElement.append(editorElement)
		formElement.append(buttons_html);
	},
